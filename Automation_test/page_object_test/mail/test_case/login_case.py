...
from page_object_test.mail.test_case.model import myunit, function
from page_object_test.mail.test_case.page_object.login_page import LoginPage
from page_object_test.mail.test_case.page_object.mail_page import MailPage
from page_object_test.mail.test_case.page_object.base import Base
...
class LoginTest(myunit.MyTest):
    ...
    def test_login_success(self):
        ...
        po.open()
        user = "13760261486"
        po.login_action(user,"hw13760261486")
        sleep(5)
        po2 = MailPage(self.driver)
        #print(po2.login_success_user())
        self.assertEqual(po2.login_success_user(),'137****1486'+"@163.com")
